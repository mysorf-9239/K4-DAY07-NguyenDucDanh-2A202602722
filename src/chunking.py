...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Split AFTER sentence-ending punctuation so punctuation is preserved.
...
class RecursiveChunker:
    ...
    def _split(
        ...
        # Empty separator means hard character-level splitting.
        if separator == "":
            return [
                current_text[start : start + self.chunk_size]
                for start in range(0, len(current_text), self.chunk_size)
        ...
        # Reattach the separator so semantic boundaries are preserved.
        parts: list[str] = []
        ...
        # Split oversized pieces recursively first.
        pieces: list[str] = []
        ...
        # Merge adjacent small pieces back towards chunk_size.
        merged: list[str] = []
        current = ""
